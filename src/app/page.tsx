...
export default function HomePage() {
  ...
  function renderHomepageSection(key: string): ReactNode {
    switch (key) {
      ...
      case "footer": return <footer className="border-t border-[var(--color-ivory)]/10 bg-[var(--color-espresso)] text-[var(--color-ivory)]"><div className="mx-auto max-w-[var(--container-max)] px-5 py-12 md:px-6"><p className="font-[var(--font-display)] text-3xl tracking-[0.08em]">IRTH</p><p className="mt-4 max-w-xl text-sm leading-7 text-[var(--color-ivory)]/60">A marketplace for authentic handmade crafts, the artisans who make them, and the heritage they carry.</p><div className="mt-10 border-t border-[var(--color-ivory)]/10 pt-6 text-xs text-[var(--color-ivory)]/40">© 2026 IRTH. All rights reserved.</div></div></footer>;
      default: return null;
    }
  }
